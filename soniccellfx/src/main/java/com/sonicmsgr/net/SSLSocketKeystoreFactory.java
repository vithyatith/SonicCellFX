...
/**
 * Util class to create SSLSocket using a KeyStore certificate to connect a
 * server
 *
 * @author gpotter2
 *
...
public class SSLSocketKeystoreFactory {
     ...
     */
    static {
        instance = "BKS"/* TODO REPLACE WITH BKS IF USING IT*/;
    ...
    public static SSLSocket getSocketWithCert(String ip, int port, InputStream pathToCert, String passwordFromCert, SecureType type) throws IOException,
        ...
        return getSocketWithCert("JKS",ip, port, pathToCert, passwordFromCert, type);
    }

    public static SSLSocket getSocketWithCert(String certType, String ip, int port, InputStream pathToCert, String passwordFromCert, SecureType type) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException {
