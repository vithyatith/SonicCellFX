...
/**
 * Util class to create SSLServerSocket using a KeyStore certificate to connect
 * a server
 *
 * @author gpotter2
 *
...
public class SSLServerSocketKeystoreFactory {
     ...
     * @param pathToCert The path to the KeyStore cert (can be with
     ...
     * @throws CertificateException If the certificate is not correct (null or
     * damaged) or the password is incorrect
     * @throws NoSuchAlgorithmException If the certificate is from an unknown
     * type
     * @throws KeyStoreException If your system is not compatible with JKS
    ...
    public static SSLServerSocket getServerSocketWithCert(int port, String pathToCert, String passwordFromCert, ServerSecureType type) throws IOException,
        ...
        return getServerSocketWithCert("JKS", port, pathToCert, passwordFromCert, type);
    }

    public static SSLServerSocket getServerSocketWithCert(String certType, int port, String pathToCert, String passwordFromCert, ServerSecureType type) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, UnrecoverableKeyException {
    ...
    public static SSLServerSocket getServerSocketWithCert(String certType, int port, InputStream pathToCert, String passwordFromCert, ServerSecureType type) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, UnrecoverableKeyException {
