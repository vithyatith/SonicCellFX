...
public class WavIOHeader {
    ...
    public WavIOHeader(String tmpPath) {
        myPath = tmpPath;
        read();
    }
...
//        
//        WavIOHeader wav = new WavIOHeader("d:\\tmp\\activepinger\\20120927_204317.wav");
//
//        int sum = wav.getSampleRate();
...
//    }
    ...
    public int getNumOfChanels(){
    	
    	return (int)myChannels;
    }
