 ...
 * @author yada
 */
public class CrytoEncryptTextComponent extends ComponentAbstraction {
    ...
    public CrytoEncryptTextComponent() {
        setName("TextEncrypt");
    ...
    public boolean start() {
        try {
           ...
           // doEncrypt = Boolean.parseBoolean(getProperty("doEncrypt").toString());
            ...
            Logger.getLogger(CrytoEncryptTextComponent.class.getName()).log(Level.SEVERE, null, ex);
