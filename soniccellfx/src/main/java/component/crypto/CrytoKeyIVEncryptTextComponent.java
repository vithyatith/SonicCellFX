 ...
 * @author yada
 */
public class CrytoKeyIVEncryptTextComponent extends ComponentAbstraction {
    ...
    public CrytoKeyIVEncryptTextComponent() {
        setName("TxtKeyIVEn");
        ...
        this.addOutput(new DataTypeIO("string", "Encrypt string"));
    }
    @Override
    ...
    public Object onExecute() {
        ...
        if (sonicCryptLib != null) {
            try {
                ...
                PubSubSingleton.getIntance().send("Print", "Key or IV doesn't match");
            }
        }
        return null;
    }
    ...
    public boolean start() {
        try {
           ...
           // doEncrypt = Boolean.parseBoolean(getProperty("doEncrypt").toString());
            ...
            Logger.getLogger(CrytoKeyIVEncryptTextComponent.class.getName()).log(Level.SEVERE, null, ex);
