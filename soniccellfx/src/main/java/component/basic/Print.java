 ...
 * @author anakin
 */
public class Print extends ComponentAbstraction {
    ...
    private boolean prettyBool = false;
    ...
    public boolean start() {
        ...
        if (getProperty("Json Pretty") != null) {
            prettyBool = Boolean.parseBoolean(getProperty("Json Pretty").toString());
        }
        if (prettyBool) {
        ...
        String run = pros.getProperty("soniccell.run");
        if (run != null) {
            if (run.equalsIgnoreCase("headless")) {
                consoleBool = true;
            }
        }
...
//
    ...
    private void init() {
        ...
        this.setProperty("Json Pretty", prettyBool);
    ...
    public void loadProperty(String key, Object value) {
        if (key.equalsIgnoreCase("Console")) {
            consoleBool = Boolean.parseBoolean(getProperty("Console").toString());
        } else if (key.equalsIgnoreCase("Json Pretty")) {
            prettyBool = Boolean.parseBoolean(getProperty("Json Pretty").toString());
        }
    }
